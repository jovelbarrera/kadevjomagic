...
namespace MagicKadevjo
{
    public partial class MagicKadevjoPage : ContentPage
    {
        ...
        private string RandomAudio()
        {
            ...
            return "https://firebasestorage.googleapis.com/v0/b/test-fda21.appspot.com/o/hey_nombe_hey.wav?alt=media&token=4230ede8-f607-4b79-91ca-edda7998f1ff";//audios[index];
        }
    }
}
